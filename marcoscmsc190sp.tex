...
both of which were previously discussed.
    ...
    \subsection{Room-8! Usage}
        ...
        separated into 7 sections: When, Cost, Location, Utilities, Lifestyle, Sex, and Misc.
    ...
    \subsection{Trial Run with Dummy Data}
    To test the application, six dummy accounts were created with three looking for a room and three having a room.
\newpage
% ACKNOWLEDGMENT
