...
% To be effective, the introduction should answer the questions ``Why and What For (Four)?" Expanded, these questions are----
    ...
    \\
    \\
    % Importance of social functioning
...
\subsection{The Importance of College Roommate Relationships}
    ...
    % Studies in the United States of America have shown that being having interracial roommates can improve a sense of belongingness and academic performance of students as measured by grade point average\cite{shook}.

    % Before proposing finding proper roommates, explain why target roommates.
    \\
    \\
