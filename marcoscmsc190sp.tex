...
\usepackage{cite, graphicx, amsmath, algorithmicx}
...
%\includegraphics[scale=\linewidth]{Architecture}
...
% This recommender system will be unsupervised
...
\caption{Gale Shapley in Room-8!}\label{gale-shapley}
    \KwData {
        \par let M be the set of people looking for a room\;
        \par let W be the set of people who have a room\;
    }
